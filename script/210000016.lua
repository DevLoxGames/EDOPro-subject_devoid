...
function s.initial_effect(c)
    ...
    aux.AddLinkProcedure(c,nil,2,2, c210000016.mfilter)
    ...
    e2:SetCondition(c210000016.mecon)
    e2:SetCountLimit(1)
    e2:SetTarget(c210000016.metg)
    e2:SetOperation(c210000016.meop)
    c:RegisterEffect(e2)

end

function c210000016.mfilter(g,lc)
    return g:IsExists(Card.IsCode,1,nil,210000006) and g:IsExists(Card.IsCode,1,nil,210000007)
end

function c210000016.indtg(e,c)
    return (c:IsSetCard(-13) and e:GetHandler():GetLinkedGroup():IsContains(c))
end



function c210000016.mecon(e,tp,eg,ep,ev,re,r,rp)
...
function c210000016.metg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c210000016.spfilter(c,e,tp)
    return c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP_DEFENSE)
end


function c210000016.meop(e,tp,eg,ep,ev,re,r,rp)
    Duel.Hint(HINT_SELECTMSG,1-tp,HINTMSG_SPSUMMON)
    local g1=Duel.SelectMatchingCard(1-tp,c210000016.spfilter,1-tp,LOCATION_GRAVE,0,1,1,nil,e,tp)
    ...
    local g2=Duel.SelectMatchingCard(tp,c210000016.spfilter,tp,LOCATION_GRAVE,0,1,1,nil,e,tp)
