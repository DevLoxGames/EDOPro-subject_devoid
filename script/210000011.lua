...
function s.initial_effect(c)
    ...
    aux.AddLinkProcedure(c,nil,2,2, c210000011.mfilter)
    ...
    e2:SetCountLimit(1)
    e2:SetCondition(c210000011.mecon)
    e2:SetTarget(c210000011.metg)
    e2:SetOperation(c210000011.meop)
    c:RegisterEffect(e2)

end

function c210000011.mfilter(g,lc)
    return g:IsExists(Card.IsCode,1,nil,210000000) and g:IsExists(Card.IsCode,1,nil,210000001)
end

function c210000011.indtg(e,c)
    return (c:IsSetCard(-13) and e:GetHandler():GetLinkedGroup():IsContains(c))
end



function c210000011.mecon(e,tp,eg,ep,ev,re,r,rp)
    return Duel.GetTurnPlayer()==tp
end
function c210000011.metg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c210000011.meop(e,tp,eg,ep,ev,re,r,rp)
